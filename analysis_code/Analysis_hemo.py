...
result_frame1 = plot_result(animal+session+'_Frame_1',frame_1,hs_frames,bl_frames,save=saving,x=100,y=160,z=0.6)
result_frame2 = plot_result(animal+session+'_Frame_2',frame_2,hs_frames,bl_frames,save=saving,x=100,y=160,z=0.6)
result_frame3 = plot_result(animal+session+'_Frame_3',frame_3,hs_frames,bl_frames,save=saving,x=100,y=160,z=0.6)

result_frame3last = plot_result(animal+session+'_Frame_-3',frame_3last,hs_frames,bl_frames,save=saving,x=100,y=160,z=0.6)
result_frame2last = plot_result(animal+session+'_Frame_-2',frame_2last,hs_frames,bl_frames,save=saving,x=100,y=160,z=0.6)
result_frame1last = plot_result(animal+session+'_Frame_-1',frame_1last,hs_frames,bl_frames,save=saving,x=100,y=160,z=0.6)
#%
plt.figure()
